...
function AddContact() {
    ...
    const handleSubmit = async (event) => {
        ...
        const requestBody = {
            ...
            emails: validEmails.map(({ id, ...item }) => ({
                email: item.email.trim(),
                label: item.label,
            })),

            phones: validPhones.map(({ id, ...item }) => ({
                                    ...
                                    (item, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="edit-label-wrapper">
                                                <label
                                                    htmlFor={`email-label-${item.id}`}
                                                >
                                                    Label
                                                </label>

                                                <select
                                                    id={`email-label-${item.id}`}
                                                    value={
                                                        item.label
                                                    }
                                                    onChange={(
                                ...
                                {form.phones.map(
                                    (item, index) => (
                                        ...
                                        >
                                            ...
                                            <div className="edit-label-wrapper">
                                                <label
                                                    htmlFor={`phone-label-${item.id}`}
                                                >
                                                    Label
                                                </label>

                                                <select
                                                    id={`phone-label-${item.id}`}
                                                    value={
                                                        item.label
                                                    }
                                                    onChange={(
